    ...
    <nav>
        <ul class="pagination row">
            ...
            @if ($paginator->onFirstPage())
                <li class="page-item disabled mt-2" aria-disabled="true" aria-label="@lang('pagination.previous')">
            ...
            @foreach ($elements as $element)
                ...
                @if (is_string($element))
                    <li class="page-item disabled mt-2" aria-disabled="true"><span class="page-link">{{ $element }}</span></li>
                @endif
